...
namespace FirstWebApplication
{
    public class Startup
    {
        ...
        {
            //use sqllite provider and connctionstring named Connect
            services.AddDbContext<NewDbContext>(options => options.UseSqlite(Configuration.GetConnectionString("Connect")));
